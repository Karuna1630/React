...
const Header=()=>{
    ...
    <ul className=" absolute inset-x-0 top-0 flex flex-row items-center justify-center w-full ">
                ...
                <li className="text-black  font-bold text-2xl py-4 px-6 "><Link to="/travelpackages">Travel Packages</Link></li>
                <li className="text-black font-bold text-2xl py-4 px-6 "><Link to="/hotels">Hotels</Link></li>
                
     </ul>

     <div className="   flex items-center justify-between gap-3 z-30">
    <span className=" text-black font-bold text-2xl " ><Link to="/profile" >Karuna123</Link></span>
    <img className=" w-12  rounded-full "src={profile} alt="Logo"/>
    </div>
