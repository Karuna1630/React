      ...
      <div className="px-5">
       <Header/>
        ...
        <div className="relative w-[86vw] h-screen  mx-[7vw]">
          ...
          <div className="my-4">
            <h1 id="hotelBooking" className=" font-serif font-semibold text-xl">Hotel Booking</h1>
          </div>

          <div className="my-4">
            <h1 className="font-semibold font-serif text-xl">Travel Packages Bookings</h1>
          </div>
        </div>
      </>
    );
